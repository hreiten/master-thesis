...
def generator(x_data, y_data, lookback=200, min_index=0, max_index=None,
              shuffle=False, batch_size=128, step=1):
    """
    Generator function for creating batches of training-data.
    This is the same generator as purposed by François Chollet in "Deep Learning with Python".
